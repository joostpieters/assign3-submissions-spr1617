...
Defines the Ingredient and IngredientList classes. The ingredient class couples
the quantity and type of ingredient. The IngredientList class creates a list
