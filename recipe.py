...
class Recipe(object):
    def __init__(*args):
        ...
        self.descr = info[3]
        self.im = info[4]
        self.ingredients = ingredients.getIngredientList(info[5])
        self.ingredientList = list()
        found = False
        for ingredient in self.ingredients:
            try:
                self.ingredientList.append(ingredient['food'].lower())
            except:
                continue
    ...
    def pretty_print(self):
        ...
        for i in range(len(self.ingredients)):
            ...
            try:
                print("\t" + "Ingredient(quantity=\"{}\", type=\"{}\")".format(ingredient["quantity"], ingredient["food"]))
            except:
                continue
        print('Instructions')
